 ...
 *   例) node scripts/caption-times.mjs 4-1-1 コンテキスト プロンプト
...
const dict = loadDict("data/pronunciation.json");
const props = JSON.parse(readFileSync(`data/${sectionId}.props.json`, "utf8"));
