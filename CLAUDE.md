...
```mermaid
flowchart LR
    A["契約・オンボーディング<br>アンケートで自業務を言語化"]
    B["基礎ターム<br>委任の体験〜型の習得"]
    C["実践ターム<br>業務に近い題材で成果物を完成"]
...
オンボーディングのアンケート（選択式＋自由記述）は、自業務の言語化＝仕様化の最初の実践を兼ね、実践タームの題材決めに使う。修了時の成果物と Before/After（削減時間等）は、受講者が経営者に報告できる形で残す。
