...
2. **オーダーメイドとアフターサポート**: 全受講者共通の教材で終わらせない。受講者は職種別題材を選び、自分の実業務を題材にした演習で成果物を作る。その先にオーダーメイド教材とアフターサポートを用意する
...
- 研修内で、自分の実業務の成果物が完成する（職種別題材と、自業務を題材にした演習）
...
| プラン | 内容 | 位置づけ |
|---|---|---|
| 本体（共通教材） | 全受講者共通・売り切り型。基礎ターム（委任の体験〜型の習得）＋実践ターム（職種別題材の選択＋自業務を題材にした演習） | MVP |
