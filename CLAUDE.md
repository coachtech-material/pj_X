...
**受講者（主対象）**: AI の進化に焦りを感じ、会社または自分の生産性に課題を感じている非エンジニアのビジネスパーソン。焦りの根には、AI に取り残される不安と、自分の職がなくなるかもしれないという不安がある。
...
2. **オーダーメイドとアフターサポート**: 全受講者共通の教材は作らない。受講企業ごとに、業務文脈を反映した教材を骨子から完全オーダーメイドで生成し、修了後はアフターサポートで定着を支える
...
- 自社の業務に合わせて生成されたオーダーメイド教材で演習し、研修内で成果物の実物が完成する
- 修了後はアフターサポートを受けられる
...
| プラン | 内容 | 位置づけ |
|---|---|---|
| 本体（オーダーメイド教材） | 受講企業ごとに、骨子（スキル体系・学習順序・題材ライブラリ）とオンボーディングアンケートから完全オーダーメイドで生成する。売り切り型 | 標準 |
...
flowchart LR
    ...
    B["教材生成<br>骨子×アンケートで御社版を制作<br>目標 3日〜1週間"]
...
オンボーディングのアンケート（選択式＋自由記述）は、自業務の言語化＝仕様化の最初の実践を兼ね、教材生成の入力に使う。制作期間中は LMS に制作中であることを表示し、待ち時間を専用教材への期待に変える。修了時の成果物と Before/After（削減時間等）は、受講者が経営者に報告できる形で残す。
