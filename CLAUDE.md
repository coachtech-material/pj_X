...
- **機能的**: 目先の業務がすぐ楽になる。学ぶのは体系的で汎用的な知見なので、以後はあらゆる業務アウトプットを最短時間・最高品質で出せる
- **情緒的**: ゲームのように楽しく、わくわくしながら AI に仕事を任せられるようになる。「課題とやることさえ把握できれば、あとはなんとかなる」というマインドで仕事に向き合える
...
- 学習体験は、ゲームのように楽しく・わくわくしながら進められることを設計原則とする。楽しめていることが、使いこなしと定着を支える
