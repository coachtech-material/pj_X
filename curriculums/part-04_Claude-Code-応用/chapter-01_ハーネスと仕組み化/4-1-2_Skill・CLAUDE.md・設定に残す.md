...
- **前提・ルール → CLAUDE.md**: 「この会社では『案件』と『商談』は別」「文体は敬体」のような、常に効かせたい前提は CLAUDE.md に書きます（3-3-1）。文体や表記の細かいルールが増えたら、`.claude/rules/` に分けます（3-3-3）
...
| 増えてきた文体・表記ルール | `.claude/rules/`（役割ごとに分割） |
